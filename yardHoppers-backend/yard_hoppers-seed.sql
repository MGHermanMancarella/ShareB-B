...
VALUES (
  ...
  (
    ...
    ' 34567 ',
    ' Address3 ',
    ' Pickled tonx chartreuse,
    trust fund pop - up hot chicken post - ironic selvage 8 - bit schlitz ',
    ' photo3.jpg '
  ),
  (
    4,
    ...
    ' 12345 ',
    ' Address4 ',
    ' Tonx helvetica mumblecore typewriter,
    readymade PBR & B polaroid taiyaki DIY deep v ',
    ' photo4.jpg '
  ),
  (
    5,
    ...
    ' 45678 ',
    ' Address5 ',
    ' Shabby chic bitters iPhone,
    yuccie adaptogen shaman dreamcatcher etsy lo - fi fam chartreuse taiyaki umami squid.',
    ' photo5.jpg '
  ),
  (
    6,
...
VALUES (1, ' user1 ', FALSE, ' Message 1 '),
...
VALUES (1, ' user1 ', ' 2023 -06 -10 ', ' 2023 -06 -15 '),
